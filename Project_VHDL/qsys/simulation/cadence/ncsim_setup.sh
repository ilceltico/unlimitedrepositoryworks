...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/qsys_onchip_memory2_0.vhd" -work onchip_memory2_0 -cdslib ./cds_libs/onchip_memory2_0.cds.lib
  ncvhdl -v93 "$QSYS_SIMDIR/qsys.vhd"                                                                                               
fi
