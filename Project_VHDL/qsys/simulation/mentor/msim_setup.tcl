...
# ACDS 13.0sp1 232 win32 2018.09.10.20:35:17
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L onchip_memory2_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L onchip_memory2_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
